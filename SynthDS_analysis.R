...
# posterior median estimator of Rho with true value = 0
median(Rho[-(1:4000)])

# 95% credible interval of Rho, lb for lower bound and up for upper bound 
lb=quantile(Rho[-(1:4000)],0.025)
ub=quantile(Rho[-(1:4000)],0.975)
lb
ub
